  ...
  sourcingCases: {
    ...
    items: [
      ...
      },
      {
        ...
        body: 'Põhjamaade kohvikuketile otsetellija spetsiaalkohvi farmid Minas Geraisist ja São Paulost. Iga farmi Rainforest Alliance ja Fair Trade sertifikaadid kontrollitud, prooviubad saadetud sertifitseeritud Q-graderile hindamiseks. Klient sai cupping-hinded, hooajalised saagimahud ja otsekontakti iga tootjaga.',
        outcome: '6 partnerit',
      },
      {
        tag: '12',
        ...
        body: 'Berliinis asuvale SaaS-firmale full-stack arendustiimid Kiievist ja Lvivist. Iga tiimi GitHub-i profiil vaadatud üle, viimased kliendiprojektid kontrollitud otsese soovitaja-kõnega. Töötasu-vahemikud, turbekäsitlus (SOC 2, ISO 27001) ja ajavööndide kattuvus selgitatud enne intervjuusid.',
      ...
      },
      {
        ...
        body: 'Balti biotech-firmale investorid Genfist ja Zürichist. Sõelutud sektori-fookuse, tšeki suuruse ja LP-koosseisu järgi (avalikud allikad + Preqin andmed). Iga kontakt kinnitatud LinkedIn-i kaudu enne pöördumist. Eelistatud esimese astme tutvustused kus võimalik.',
        outcome: '4 kohtumist',
      },
      {
        tag: '14',
        ...
        body: 'EL hulgimüüjale geneeriliste ravimite tootjad Hyderabadis ja Mumbais. Iga tehase USFDA ja EMA GMP staatus kontrollitud otse regulaatorite andmebaasidest. Miinimumkogused, tarnetingimused ja pakendamislitsentsid selgeks räägitud kohe alguses.',
        outcome: '4 finalisti',
      },
      {
        tag: '15',
        ...
        body: 'Skandinaavia jaeketile veinitootjad Douro ja Alentejo piirkondadest. Iga viinamarjaistanduse orgaanilised sertifikaadid ja aastane toodangumaht kontrollitud, prooviproovid saadetud sommelierile hindamiseks. Etiketikujundus ja ekspordi-logistika kokku lepitud enne kliendile üleandmist.',
        outcome: '3 partnerit',
      },
    ],
  },
