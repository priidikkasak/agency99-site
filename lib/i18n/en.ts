...
export const en: Translations = {
  ...
  services: {
    ...
    extra: 'I also offer automation, design, and marketing services - just ask.',
  },
  pricing: {
    ...
    tiers: [
      {
        ...
        features: [
          'Full marketing site (home, services, pricing, contact)',
          'Loads fast everywhere - Tallinn to Tokyo',
          'Secure hosting included (year one)',
      ...
      },
      {
        ...
        features: [
          ...
          'Newsletter integration (Mailchimp · Resend · Klaviyo)',
      ...
      },
      {
        ...
        features: [
          ...
          'Lead form that tags every source automatically',
          'AI content engine (unlimited social posts)',
