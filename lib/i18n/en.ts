    ...
    items: [
      {
        ...
        body: 'ENplus A1 producers for a German retail chain, sourced in 8 days. Every cert verified in the ENplus registry, every rep called. Only mills under €350/t with 500+ tons/month made the shortlist.',
      ...
      },
      {
        ...
        body: "Active investors sourced for a Baltic developer's seed round. Screened by ticket size, asset class and past deals. Every contact confirmed by phone before handoff.",
        outcome: '€4.2M raised',
      },
      {
        tag: '03',
        ...
        body: 'Direct-to-metal precious metal partners for a jewelry brand. Most listings are resin, not real SLM. Every European qualifier mapped and tested with a sample order.',
      ...
      },
      {
        ...
        category: 'Contacts',
        title: 'Ecom COOs, UK',
        body: 'COOs, Heads of Ops and Fulfilment at £5-50M UK ecom brands. Emails verified via 3-provider waterfall. Every message referenced a recent hire or press signal.',
      ...
      },
      {
        ...
        body: 'Investment-grade properties in Estonia and Latvia. Sourced from brokers, owners, quiet lists and local property lawyers who hear before assets list. Every property visited.',
      ...
      },
      {
        ...
        body: 'Fitness apparel manufacturers vetted by sample order, not brochure claims. SGS and Bureau Veritas reports cross-checked. Finalists came with pricing, lead times and named contacts.',
        outcome: '8 finalists',
      },
      {
        tag: '07',
        ...
        body: "EU and UK funds for a payments startup. Screened by thesis, stage and cheque size. Every message referenced a fund's most recent portfolio move.",
        outcome: 'Round closed in 12 weeks',
      },
      {
        tag: '08',
        category: 'Manufacturers',
        title: 'Private-label cosmetics, Southern Europe',
        body: 'Skincare labs in Italy, Spain and Portugal. Every GMP, ISO 22716, ECOCERT cert checked. Sample formulations ordered before shortlisting.',
      ...
      },
      {
        ...
        body: 'Sensor-module supplier for a hardware startup. Category flooded with resellers posing as factories. Every candidate verified with sample test, LinkedIn history and factory-visit video.',
        outcome: '3 finalists',
      },
      {
        tag: '10',
        ...
        body: 'Mixed-use €5-15M assets for a Baltic investor. Sourced via brokers, direct owners and bank NPL portfolios - assets that never list publicly. Screened for yield, tenants, refurb cost.',
